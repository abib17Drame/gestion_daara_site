...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $result = $supabase->update('eleves', $data, ['id' => $id]);
        
        if ($result) {
            $_SESSION['success_message'] = "L'élève a été modifié avec succès!";
            header("Location: ".$rediriger_vers);
            exit();
        } else {
            $_SESSION['error_message'] = "Une erreur est survenue lors de la modification de l'élève.";
        }
    } else {
    ...
    <div class="col-lg-6">
        <div class="card shadow-sm">
            <div class="card-header bg-success text-white">
                <h3 class="h5 mb-0"><i class="fas fa-user-edit me-2"></i>Modifier un Élève</h3>
            </div>
            <div class="card-body">
                ...
                <form method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="age" name="age" 
                                       value="<?php echo htmlspecialchars($eleve['age']); ?>" min="0" max="120">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="niveau" name="niveau" required>
                                    <option value="Petite Section" <?php echo $eleve['niveau'] == 'Petite Section' ? 'selected' : ''; ?>>Petite Section</option>
                                    <option value="Moyenne Section" <?php echo $eleve['niveau'] == 'Moyenne Section' ? 'selected' : ''; ?>>Moyenne Section</option>
                                    <option value="Grande Section" <?php echo $eleve['niveau'] == 'Grande Section' ? 'selected' : ''; ?>>Grande Section</option>
                                    <option value="Coranique" <?php echo $eleve['niveau'] == 'Coranique' ? 'selected' : ''; ?>>Coranique</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nom_complet_tuteur" name="nom_complet_tuteur"
                                       value="<?php echo htmlspecialchars($eleve['nom_complet_tuteur']); ?>">
                                <div class="form-text">Optionnel</div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="telephone_tuteur" name="telephone_tuteur" 
                                           value="<?php echo htmlspecialchars($eleve['telephone_tuteur']); ?>" placeholder="+221...">
                                </div>
                                <div class="form-text">Format: +221xxxxxxxxx ou 7xxxxxxxx</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo $rediriger_vers; ?>" class="btn btn-outline-secondary">
